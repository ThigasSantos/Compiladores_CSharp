...
ExpressaoMod *ExpressaoMod::extrair(No_arv_parse *no) {
  auto *e = new ExpressaoMod();
...
Valor *ExpressaoMod::simular_execucao(TabelaDeSimbolos *tabela_de_simbolos) {
...
Valor *ExpressaoMod::analisar_semantica(TabelaDeSimbolos *tabela_de_simbolos) {
